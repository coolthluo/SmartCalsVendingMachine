...
public class Const {
	...
	//customer constants
	public final static String ADD_CARD = "ADD_CARD";
	...
	//machine constants
	public final static String GET_UPDATED_ITEMS = "GET_UPDATED_ITEMS";
	public final static String ADD_SALE = "ADD_SALE";
	
	//manager constants
	public final static String AUTHENTICATE_MANAGER = "AUTH_MAN";
	public final static String ADD_ITEM = "ADD_ITEM";
	public final static String UPDATE_ITEM = "UPDATE_ITEM";
	public final static String ADD_EMPLOYEE = "ADD_EMPLOYEE";
	public final static String GET_EMPLOYEE = "GET_EMPLOYEE";
	public final static String GET_ALL_MACHINES = "GET_ALL_MACHINES";
